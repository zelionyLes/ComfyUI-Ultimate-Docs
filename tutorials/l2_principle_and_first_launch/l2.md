...
2. Perform a double-click anywhere you want to pop up the search bar
...
![load vae node](images/load_vae_node.png)
...
> We'll talk more about prompt influence when we discuss the **Ksampler** (pretty soon), so buckle up!
